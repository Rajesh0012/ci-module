...
<html lang="en">
   <head>
      ...
      <link rel="icon" type="image/png" sizes="32x32" href="<?php echo BASE_URL . '/web/' ?>images/facv-icon.png">
      <!-- Bootstrap Core CSS -->
      <link href="<?php echo BASE_URL . '/web/' ?>css/plugin/bootstrap.css" rel="stylesheet">
      <link rel="stylesheet" href="<?php echo BASE_URL . '/web/' ?>css/plugin/bootstrap-select.min.css">
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.css" rel="stylesheet">
      <link rel="stylesheet" href="<?php echo BASE_URL . '/web/' ?>css/plugin/owl.carousel.min.css">
      <link href="<?php echo BASE_URL . '/web/' ?>css/style.css" rel="stylesheet">
      <link href="<?php echo BASE_URL . '/web/' ?>css/media.css" rel="stylesheet">
      <link href="<?php echo BASE_URL . '/web/' ?>css/web.css" rel="stylesheet">
       <script>
            ...
            <div class="container">
               <div class="top-nav clearfix">
                  ...
                  <div class="top-brand-wrap">
                     <a href="<?php echo base_url(); ?>web"><img src="<?php echo BASE_URL . '/web/' ?>images/logo.svg" alt="chekiodds"></a>
                  </div>
                  ...
                  <div class="top-menu-wrap">
                     ...
                     <ul>
                        ...
                        <li>
                           <a href="<?php echo SITE_URL . '/web/tips' ?>">Free Tips </a>
                        </li>
                        <li>
                           ...
                           <span class="sports-name">All Sports</span>
                             ...
                             <?php if(isset($sports) && !empty($sports)): foreach ($sports as $key=>$values): ?>
                                 <div class="item">
                                     ...
                                     <a class="<?php if($this->input->get('id') == $values->sport_id) { echo 'active';} ?>" href="<?php if($values->sport_name=='Basketball'){ echo base_url() ?>web/home/basketball?id=<?php echo $values->sport_id; }else if($values->sport_name=='Rugby'){ echo base_url() ?>web/home/rugby?id=<?php echo $values->sport_id; }else if($values->sport_name=='Football'){ echo base_url() ?>web/home/football?id=<?php echo $values->sport_id; }else if($values->sport_name=='Cricket'){ echo base_url() ?>web/home/cricket?id=<?php echo $values->sport_id; }else if($values->sport_name=='Tennis'){ echo base_url() ?>web/home/tennis?id=<?php echo $values->sport_id; }else if($values->sport_name=='Golf'){ echo base_url() ?>web/home/golf?id=<?php echo $values->sport_id; }else if($values->sport_name=='Boxing'){ echo base_url() ?>web/home/boxing?id=<?php echo $values->sport_id; } ?>">
            ...
            <div class="search-list-wrap">
               ...
               <ul>
                  <li><a href="javascript:void(0)" class="clearfix">
                     <span class="sport-icon" style="background-image: url(<?php echo base_url(); ?>/web/images/football-b.svg);"></span>
                  ...
                  <li><a href="javascript:void(0)" class="clearfix">
                     <span class="sport-icon" style="background-image: url(images/football-b.svg);"></span>
                     <span class="team-sports-wrap">
                     <span class="title">Man United</span>
                     <span class="team">Trophy Multiples | All Football Specials</span>
                     </span>
            ...
            <div class="container">
               <div class="block-add clearfix">
                  <div class="top-left-banner-wrap">
                     <img src="<?php echo BASE_URL . '/web/' ?>images/addblock-img-1.png" class="banner-add">
                  </div>
                  <div class="top-right-banner-wrap">
                     <img src="<?php echo BASE_URL . '/web/' ?>images/addblock-img-2.png" class="banner-add">
                  </div>
               </div>
            </div>
         </div>
