...
<div class="container">
    <div class="center-block-wrapper clearfix">
        ...
        <div class="tab-wraper clearfix">
            <ul class="clearfix">
                <li><a href="javascript:void(0)" onclick="getData('<?php echo base64_encode('all'); ?>','Rugby','<?php echo $_GET['id']; ?>')" data-in="#tab1" class="<?php if(empty($this->input->get('tour_id'))) echo 'active'; ?>"><?php echo 'Rugby'; ?></a></li>
                <?php if(!empty($tournament_arr))
                {
                    foreach($tournament_arr as $tour){
                        ?>
                        <li><a href="javascript:void(0)" onclick="getData('<?php echo base64_encode($tour['tournament_id']); ?>','<?php echo $tour['sport_name']; ?>','<?php echo $_GET['id']; ?>')" data-in="#tab1" class="<?php if($tour['tournament_id'] == base64_decode($this->input->get('tour_id'))){ echo 'active';} ?>"><?php echo $tour['tournament_name']; ?></a></li>
                        <?php
            ...
            <div class="game-bet-col">
                <div class="inner-game-bet-col">
                    <div class="header weekly-game">
                        <h2 class="heading">Rugby Odds</h2>
                        <span class="game-date">Rugby Matches</span>
                    </div>
                                ...
                                <ul class="cricket-game-li">
                                    ...
                                    <span class="view-state"><a href="javascript:void(0)">View Game Stats</a></span>
                                        ...
                                        <div class="view-tips-odd-col text-center">
                                            <ul>
                                               <li><button onclick="return window.location.href='<?php echo base_url() ?>web/Home/match_odds?matchId=<?php echo base64_encode($listvalues['match_id']).'&id='.base64_encode($listvalues['id']).'&market_name='.base64_encode($listvalues['market_name']).'&sport_name=rugby&link_id='.$this->input->get('id'); ;  ?>'" class="view-od-tps-btn">View Odds</button></li>
