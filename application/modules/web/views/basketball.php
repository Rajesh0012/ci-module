...
<div class="container">
            ...
            <div class="tab-wraper clearfix">
                        <ul class="clearfix">
                            <li><a href="javascript:void(0)" onclick="getData('<?php echo base64_encode('all'); ?>','Basketball','<?php echo $_GET['id']; ?>')" data-in="#tab1" class="active"><?php echo 'Basketball'; ?></a></li>
               ...
               <div class="commn-col-wrap clearfix">
                  ...
                  <div class="game-bet-col">
                      <div id="dataappendhere"  class="inner-game-bet-col">
                          <div class="header weekly-game">
                              <h2 class="heading">Basketball Odds</h2>
                              <span class="game-date">Basketball Matches</span>
                          </div>
                          <?php if(isset($res_arr) && !empty($res_arr)): foreach ($res_arr as $key=>$values): ?>
                              <div   class="weekly-game-list-wrap clearfix">
                                  <?php if(!empty($values['schedule_r_date'])): ?>
                                  <h2 class="prev-date-wrap"><?php echo date('D, d M Y',strtotime($values['schedule_r_date'])); ?></h2>
                                  <?php endif; ?>
                                  <ul  class="cricket-game-li">
                                  <?php if(!empty($values['detail_arr'])): foreach ($values['detail_arr'] as $listkey=>$listvalues):  ?>
                                    ...
                                    <span class="view-state"><a href="javascript:void(0)">View Game Stats</a></span>
                                              ...
                                              <div class="view-tips-odd-col text-center">
                                                  <ul>
                                                      ...
                                                      <li><button onclick="return window.location.href='<?php echo base_url() ?>web/Home/match_odds?matchId=<?php echo base64_encode($listvalues['match_id']).'&id='.base64_encode($listvalues['id']).'&market_name='.base64_encode($listvalues['market_name']).'&sport_name=basketball&link_id='.$this->input->get('id');  ?>'" class="view-od-tps-btn">View Odds</button></li>
                    ...
                    <!--  <div class="weekly-game-list-wrap clearfix">
                          <span id="<?php /*echo  $this->input->get('id'); */?>" onclick="loadMoreData(this.id)" class="not_found">Load More</span>
                      </div>-->
