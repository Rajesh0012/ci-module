...
<div class="container">
    <div class="center-block-wrapper clearfix">
        ...
        <div class="tab-wraper clearfix">
            <ul class="clearfix">
                <li><a href="javascript:void(0)" onclick="getData('<?php echo base64_encode('all'); ?>','Golf','<?php echo $_GET['id']; ?>')" data-in="#tab1" class="active"><?php echo 'Golf'; ?></a></li>
            ...
            <div class="game-bet-col">
                <div class="inner-game-bet-col">
                    <div class="header weekly-game">
                        <h2 class="heading">Golf Odds</h2>
                        <span class="game-date">Golf Matches</span>
                    </div>
