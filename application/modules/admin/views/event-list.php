                                ...
                                if (in_array('sr:book:6', $values->bookies)) {
                                    if (isset($values->odds[$key]) && !empty($values->odds[$key])) {
                                        if (isset($values->comptitors_id) && !empty($values->comptitors_id))
                                            echo '<td><span class="view-odds"><a id="' . $values->category_id . '|=|' . $values->comptitors_id . '|=|' . $values->bookies[$key] . '|=|' . $tournament_id . '|=|' . $match_id . '|=|' . $values->odds[$key] . '|=|' . $values->sport_id . '" onclick="add(this.id)" href="javascript:void(0)">' . $values->odds[$key] . '</a></span></td>';
                                        else
                                            echo '<td><span class="view-odds"><a id="' . $values->category_id . '|=|' . $values->bookies[$key] . '|=|' . $tournament_id . '|=|' . $match_id . '|=|' . $values->odds[$key] . '|=|' . $values->sport_id . '" onclick="add(this.id)" href="javascript:void(0)">' . $values->odds[$key] . '</a></span></td>';
                                    } else {
                                        echo "<td>-</td>";
                                    }
                                } else {
